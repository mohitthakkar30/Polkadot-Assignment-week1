...
solution: removed line y=x and added data type of z.
...
solution: Added 127 and 255 as in the max value of i8 and u8.
...
solution: added f64 in cmnt area to describe its type.
...
soluion: added _f32 in the line to get float output.
...
solution: Added unsigned datatype in some areas and true, false in boolean logic.
